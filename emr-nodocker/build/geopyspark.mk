...
archives/geopyspark-$(GEOPYSPARK_VERSION)-13.x86_64.rpm archives/geopyspark-worker-$(GEOPYSPARK_VERSION)-13.x86_64.rpm: rpmbuild/SPECS/geopyspark.spec scripts/geopyspark.sh \
$(shell scripts/not.sh archives/rpmbuild.tar) archives/geopyspark.tar \
