...
archives/jupyterhub-0.7.2-13.x86_64.rpm: rpmbuild/SPECS/jupyterhub.spec scripts/jupyterhub.sh \
$(shell scripts/not.sh archives/rpmbuild.tar) archives/jupyterhub.tar \
archives/ipykernel-629ac54cae9767310616d47d769665453619ac64.zip archives/geopyspark-$(GEOPYSPARK_VERSION)-13.x86_64.rpm archives/nodejs-8.5.0-13.x86_64.rpm
	docker run -it --rm \
          -v $(shell pwd)/archives:/archives:rw \
          -v $(shell pwd)/scripts:/scripts:ro \
