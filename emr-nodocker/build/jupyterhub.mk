...
rpmbuild/RPMS/x86_64/jupyterhub-0.7.2-13.x86_64.rpm: rpmbuild/SPECS/jupyterhub.spec scripts/jupyterhub.sh rpmbuild/SOURCES/jupyterhub.tar \
archives/ipykernel-629ac54cae9767310616d47d769665453619ac64.zip rpmbuild/RPMS/x86_64/geopyspark-$(GEOPYSPARK_VERSION)-13.x86_64.rpm rpmbuild/RPMS/x86_64/nodejs-8.5.0-13.x86_64.rpm
	docker run -it --rm \
