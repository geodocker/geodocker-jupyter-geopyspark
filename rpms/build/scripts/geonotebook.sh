...
yum install -y \
    ...
    /tmp/rpmbuild/RPMS/x86_64/jupyterhub-0.7.2-13.x86_64.rpm \
    ...
    /tmp/rpmbuild/RPMS/x86_64/boost162-lib-1_62_0-33.x86_64.rpm \
    /tmp/rpmbuild/RPMS/x86_64/mapnik-093fcee-33.x86_64.rpm \
    /tmp/rpmbuild/RPMS/x86_64/python-mapnik-e5f107d-33.x86_64.rpm
ldconfig
